...
-(void)updateInteractiveTransition:(CGFloat)percentComplete{
    ...
    /**
     self.moviePlayer.playbackState != MPMoviePlaybackStateStopped && self.moviePlayer.playbackState != MPMoviePlaybackStatePaused
     */
    if (self.moviePlayer.player.status != 1) {
        if (self.toTransform != self.orientationTransformBeforeDismiss) {
